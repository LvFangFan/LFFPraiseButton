...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // star button
        let starButton = LFFPraiseButton(frame: CGRect(x: x, y: y, width: 44, height: 44), image: UIImage(named: "star"))
        starButton.addTarget(self, action: #selector(tappedButton), for: .touchUpInside)
        self.view.addSubview(starButton)
        x += width
        
        // heart button
        let heartButton = LFFPraiseButton(frame: CGRect(x: x, y: y, width: 44, height: 44), image: UIImage(named: "heart"))
        ...
        // like button
        let likeButton = LFFPraiseButton(frame: CGRect(x: x, y: y, width: 44, height: 44), image: UIImage(named: "like"))
        ...
        // smile button
        let smileButton = LFFPraiseButton(frame: CGRect(x: x, y: y, width: 44, height: 44), image: UIImage(named: "smile"))
...
//        self.heartButton.addTarget(self, action: #selector(self.tappedButton), for: .touchUpInside)
    ...
    @objc func tappedButton(sender: LFFPraiseButton) {
